  ...
  return (
    <>
      ...
      <main>
        ...
        <section id="services" className="section services-section scroll-reveal">
        ...
        <section id="expect" className="section expect-section scroll-reveal">
        ...
        <section id="comfort" className="section comfort-section scroll-reveal">
        ...
        <section id="pricing" className="section soft scroll-reveal">
          <div className="section-heading">
        ...
        <section id="reviews" className="section reviews-section scroll-reveal">
          <div className="section-heading centered">
        ...
        <section id="booking" className="section booking-section scroll-reveal">
        ...
        <section id="faq" className="section faq-section scroll-reveal">
          <div className="section-heading">
        ...
        <section id="contact" className="section split section-lift scroll-reveal">
          <div>
