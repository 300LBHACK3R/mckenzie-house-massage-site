...
export const whatToExpect = [
  {
    ...
    text: "Clients will be able to review services, pricing, and booking details clearly before choosing a treatment.",
  },
  {
...
export const experiencePillars = [
  ...
  },
  {
    ...
    text: "Each treatment will be explained in plain language so clients know what to book and what to expect.",
  },
  {
...
export const faqs = [
  {
    ...
    answer:
      "The website will help explain each service clearly. Heather can also guide clients toward the treatment that best fits their comfort level and goals.",
  },
  {
    question: "Can pressure be adjusted during the session?",
    answer:
      "Yes. The treatment should be adjusted to the client’s comfort, preference, and goals throughout the appointment.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Online booking will connect directly through Heather’s existing ClinicSense booking system.",
  },
  {
